...
这些模块成功实现了lab1中的**所有需求**以及**增强部分的需求**，并且都通过了完整测试。
...
<img src="assets/image-20241127215448332.png" alt="image-20241127215448332" style="zoom: 80%;" />
...
测试目录下包括**90**个项目测试，可以通过这些测试来判断项目是否运行正常。

<img src="assets/image-20241127215418127.png" alt="image-20241127215418127" style="zoom:67%;" />
