...
- `undo()`����
    ...
    - ������ѹ��`redoStack`
    - ִ������ĳ����߼�
    - ��ջΪ�գ��׳�`NoUndoableOperationException`
...
- `redo()`����
    ...
    - ������ѹ��`undoStack`
    - ����ִ������
    - ��ջΪ�գ��׳�`NoRedoableOperationException`
...
##### (6) ��������
- `peekLast()`����ȡ���ִ�е���������Ƴ�
- ���޿ɳ�������׳�`NoUndoableOperationException`

##### (7) �쳣����
- �Զ����쳣��`NoUndoableOperationException`
- �Զ����쳣��`NoRedoableOperationException`
- ȷ�����޿ɳ��������������ʱ�ṩ��ȷ�Ĵ�����ʾ

##### (8) ���ģʽӦ��
- ����ģʽ���������װΪ����֧�ֳ���������
- ջ���ݽṹ����Ч����������ʷ
- ��һְ��ԭ��CommandHistoryרע��������ʷ����
